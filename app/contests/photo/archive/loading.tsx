// app/contests/photo/archive/loading.tsx [SERVER]
...
export default function PhotoArchiveLoading() {
  return (
    <div style={{ paddingTop: "48px", paddingBottom: "80px" }}>
      ...
      <div className="shell">
        ...
        <div style={{ ...pulse, height: "36px", width: "200px", marginBottom: "12px" }} />
        <div style={{ ...pulse, height: "16px", width: "300px", marginBottom: "48px" }} />
