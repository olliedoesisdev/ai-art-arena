// app/contests/ai-art/archive/page.tsx [SERVER]
...
export const metadata: Metadata = {
  title: "AI Art Archive — AI Art Arena",
  description: "Browse past AI art voting contests and their winning artworks.",
  alternates: { canonical: `${SITE_URL}/contests/ai-art/archive` },
  openGraph: {
    title: "AI Art Archive — AI Art Arena",
    description: "Browse past AI art voting contests and their winning artworks.",
    url: `${SITE_URL}/contests/ai-art/archive`,
    siteName: "AI Art Arena",
    images: [{ url: `${SITE_URL}/og-image.png`, width: 1200, height: 630, alt: "AI Art Arena archive" }],
    type: "website",
  },
  twitter: {
...
export default async function AiArtArchivePage() {
    ...
    <div className="animate-page" style={{ paddingTop: "48px", paddingBottom: "80px" }}>
      <div className="shell">
        ...
        <p style={{ color: "var(--color-text-muted)", fontSize: "15px", margin: "0 0 48px" }}>
          Every past AI art contest, final votes, and winner on record.
        </p>
        ...
        {!contests || contests.length === 0 ? (
          <div style={{ textAlign: "center", padding: "80px 20px", background: "var(--color-bg-surface)", border: "1px solid var(--color-border-subtle)", borderRadius: "14px" }}>
            <p style={{ fontSize: "0.875rem", color: "var(--color-text-muted)" }}>
              No archived AI art contests yet.
            </p>
          </div>
        ) : (
