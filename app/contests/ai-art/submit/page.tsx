// app/contests/ai-art/submit/page.tsx [SERVER]
...
export const metadata: Metadata = {
  title: "Submit AI Art — AI Art Arena",
  description: "Sign in and submit AI-generated artwork to an active contest.",
  alternates: { canonical: `${SITE_URL}/contests/ai-art/submit` },
  robots: { index: false, follow: true },
};

export default async function AiArtSubmitLandingPage() {
  const session = await auth();

  if (!session?.user) {
    redirect("/api/auth/signin?callbackUrl=/contests/ai-art/submit");
  }
    ...
    <div className="animate-page" style={{ paddingTop: "48px", paddingBottom: "80px" }}>
      <div className="shell" style={{ maxWidth: "640px" }}>
        ...
        <p style={{
          ...
          Pick an active contest below and upload your artwork. All submissions are reviewed before going live.
        </p>
        ...
        {!activeContests || activeContests.length === 0 ? (
          ...
          >
            ...
            <p style={{ fontSize: "0.9375rem", color: "var(--color-text-muted)", lineHeight: 1.6, marginBottom: "24px" }}>
              There are no open AI art contests right now. Check back soon.
            </p>
            <Link
              href="/contests"
              style={{
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
            {activeContests.map((contest) => {
              ...
              const contestTitle = contest.theme ?? `AI Art Contest #${contest.contest_number}`;
